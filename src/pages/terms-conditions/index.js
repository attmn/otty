        ...
        <div className={styles.container}>
          <div className={styles.sectionContainer}>
            ...
            <div className={styles.sectionDiv}>
              <p>Last updated 10th November 2022</p>
            </div>
            <div className={styles.sectionDiv}>
              ...
              <p>
                ...
                ("you") and Teman Ltd., doing business as Otty Cleaner ("Otty
                Cleaner," "we," "us," or "our"), concerning your access to and
                use of the https://ottycleaner.co.uk website as well as any
                other media form, media channel, mobile website or mobile
                application related, linked, or otherwise connected thereto
                (collectively, the "Site"). We are registered in the United
                Kingdom and have our registered office at Suite 1065, Unit 3a,
                34-35 Hatton Garden, London EC1N 8DX. You agree that by
              ...
              <p>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    laws or regulations. Engage in unauthorized framing of or
                    linking to the Site.
                  </li>
                  <li>
                    ...
                    Site. · Engage in any automated use of the system, such as
                  ...
                  <li>
                    ...
                    the Site. Copy or adapt the Site's software, including but
            ...
            <div className={styles.sectionDiv}>
              ...
              <p>
                ...
                or any contact with ThirdParty Websites.
              </p>
            </div>
            <div className={styles.sectionDiv}>
              <h3>9. SITE MANAGEMENT</h3>
              <p>
            ...
            <div className={styles.sectionDiv}>
              ...
              <p>
                ...
                <Link to="/cookies-policy">
                  http://ottycleaner.co.uk/cookies-policy.
                </Link>{" "}
                ...
                the Site is hosted in the United Kingdom. If you access the Site
                ...
                Kingdom, then through your continued use of the Site, you are
                transferring your data to the United Kingdom, and you agree to
            ...
            <div className={styles.sectionDiv}>
              ...
              <p>
                ...
                country of residence. Teman Ltd. and yourself both agree to
                submit to the non-exclusive jurisdiction of the courts of which
                means that you may make a claim to defend your consumer
                protection rights in regards to these Terms of Use in the United
            ...
            <div className={styles.sectionDiv}>
              ...
              <p>
                ...
                <a
                  ...
                  aria-label="EC Online dispute resolution"
                >
            ...
            <div className={styles.sectionDiv}>
              <h3>19. USER DATA</h3>
              <p>
                https://ottycleaner.co.uk V liability to you for any loss or
            ...
            <div className={styles.sectionDiv}>
              ...
              <p>
                Teman Ltd. <br />
                Suite 1065, Unit 3a, 34-35 Hatton Garden <br />
                London
                <br />
                EC1N 8DX
                <br />
